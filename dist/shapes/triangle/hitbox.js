...
*/
export const triangleHitbox = (schema) => (point) => {
...
export const getTriangleBoundingBox = (triangle) => () => {
...
export const triangleEfficientHitbox = (schema) => (boxToCheck) => areBoundingBoxesOverlapping(getTriangleBoundingBox(schema)(), boxToCheck);
