...
export const uturnHitbox = (schema) => {
...
export const getUTurnBoundingBox = (schema) => () => {
...
export const uturnEfficientHitbox = (schema) => (boxToCheck) => areBoundingBoxesOverlapping(getUTurnBoundingBox(schema)(), boxToCheck);
