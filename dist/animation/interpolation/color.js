 ...
 */
export const isColorString = (color) => isColor(tinycolor(color));
export const isColor = (color) => color.isValid();
export const interpolateColor = (keyframes, defaultEasing, fallback) => (progress) => {
    ...
    for (let i = 0; i < keyframes.length - 1; i++) {
        ...
        if (progress >= startKeyframe.progress &&
